...
public class TransactionalClassTest extends AbstractPersistTest {
    ...
    @Test
    public void transactionsStartAndEndAroundMethods() {
        getUnitOfWork().begin();
    ...
    @Test
    public void checkedExceptionCausesRollback() throws SQLException {
        testRollbackOccurs(CheckedExceptionThrowingRepository.class, FileNotFoundException.class);
    }

    @Test
    public void ignoredCheckedExceptionDoesNotCauseRollback() throws SQLException {
        testRollbackDoesNotOccur(IgnoredCheckedExceptionThrowingRepository.class, FileNotFoundException.class);
    }

    @Test
    public void ignoredRuntimeExceptionDoesNotCauseRollback() throws SQLException {
